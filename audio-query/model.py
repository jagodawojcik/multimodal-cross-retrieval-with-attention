...
class CrossSensoryNetwork(nn.Module):
    ...
    def forward(self, audio_input, tactile_input, visual_input):
        ...
        attn_out1, _ = self.attention(tactile_output.unsqueeze(0), visual_output.unsqueeze(0), visual_output.unsqueeze(0))
        attn_out2, _ = self.attention(visual_output.unsqueeze(0), tactile_output.unsqueeze(0), tactile_output.unsqueeze(0))
